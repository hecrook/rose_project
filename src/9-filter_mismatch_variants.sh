...
VCFs=("$BASE_DIR/results/vcf_expression_annotator/PLUMMB_26/PLUMMB_26.sobdetector.hcfiltered.adrlar.mutect2.filtered.snvsonly_VEP.ann.gx.vcf" "${BASE_DIR}/results/vcf_expression_annotator/R11_BL/R11_BL.sobdetector.hcfiltered.adrlar.mutect2.filtered.snvsonly_VEP.ann.gx.vcf" "${BASE_DIR}/results/vcf_expression_annotator/PLUMMB_16/PLUMMB_16.sobdetector.hcfiltered.adrlar.mutect2.filtered.snvsonly_VEP.ann.gx.vcf")
